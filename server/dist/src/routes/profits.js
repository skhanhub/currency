...
router.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var fromDate, toDate, currencySelected, currencyAnalyser, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                currencySelected = req.body.currencySelected;
            ...
            case 1:
                // Load the most recent data
                _a.sent();
                result = currencyAnalyser.annalyseCurrency(fromDate, toDate, currencySelected);
